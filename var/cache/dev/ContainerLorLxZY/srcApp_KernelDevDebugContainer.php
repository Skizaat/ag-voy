...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jXMtREZ9Qp', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xRjTp-zOpw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\OwnerRepository' => ['privates', 'App\\Repository\\OwnerRepository', 'getOwnerRepositoryService', false],
     ...
     */
    protected function getOwnerRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/OwnerRepository.php';

        return $this->privates['App\\Repository\\OwnerRepository'] = new \App\Repository\OwnerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jAO0ht4x1K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JvvkBM5mWb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RXWk9XdBdP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('crGWjV+UgQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J0Raw+P+EI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldere24dc = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer8f9c5 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties7687e = [
        
    ];

    public function getConnection()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getConnection', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getMetadataFactory', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getExpressionBuilder', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'beginTransaction', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getCache', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getCache();
    }

    public function transactional($func)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'transactional', array('func' => $func), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'wrapInTransaction', array('func' => $func), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'commit', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->commit();
    }

    public function rollback()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'rollback', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getClassMetadata', array('className' => $className), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'createQuery', array('dql' => $dql), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'createNamedQuery', array('name' => $name), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'createQueryBuilder', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'flush', array('entity' => $entity), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'clear', array('entityName' => $entityName), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->clear($entityName);
    }

    public function close()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'close', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->close();
    }

    public function persist($entity)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'persist', array('entity' => $entity), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'remove', array('entity' => $entity), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'refresh', array('entity' => $entity), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'detach', array('entity' => $entity), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'merge', array('entity' => $entity), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getRepository', array('entityName' => $entityName), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'contains', array('entity' => $entity), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getEventManager', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getConfiguration', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'isOpen', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getUnitOfWork', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getProxyFactory', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'initializeObject', array('obj' => $obj), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'getFilters', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'isFiltersStateClean', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'hasFilters', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return $this->valueHoldere24dc->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer8f9c5 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldere24dc) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldere24dc = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldere24dc->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, '__get', ['name' => $name], $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        if (isset(self::$publicProperties7687e[$name])) {
            return $this->valueHoldere24dc->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldere24dc;
    ...
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;
    ...
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, '__isset', array('name' => $name), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;
    ...
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, '__unset', array('name' => $name), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;
    ...
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, '__clone', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        $this->valueHoldere24dc = clone $this->valueHoldere24dc;
    }

    public function __sleep()
    {
        $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, '__sleep', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;

        return array('valueHoldere24dc');
    }
    ...
    {
        $this->initializer8f9c5 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer8f9c5;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer8f9c5 && ($this->initializer8f9c5->__invoke($valueHoldere24dc, $this, 'initializeProxy', array(), $this->initializer8f9c5) || 1) && $this->valueHoldere24dc = $valueHoldere24dc;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldere24dc;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldere24dc;
    }
}
